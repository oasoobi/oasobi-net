  ...
  return (
    <main className="min-h-lvh pt-14">
      <div className="select-none ml-[2%] mr-[2%] w-[80%] mb-10">
        <h1 className="text-3xl font-bold mb-5">配布物</h1>
        <h1 className="text-2xl ml-2 font-bold mt-2 mb-2">アドオン</h1>
      ...
      <h1 className="text-2xl ml-2 font-bold mb-2 mt-2">その他</h1>
      </div>
