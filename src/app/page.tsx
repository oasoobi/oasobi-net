...
export default function Home() {
  return (
    <main className="min-h-lvh h-auto select-none flex justify-center">
      <div className="flex justify-center flex-col h-auto">
        ...
        <div className="grid grid-cols-2 sm:grid-cols-3 justify-center gap-4 w-full">
          ...
          <Link href={"https://twitter.com/oasoby"} target="_blank" rel="noopener noreferrer" className="h-[140px] w-[140px]">
          ...
          <Link href={"https://github.com/oasoobi"} target="_blank" rel="noopener noreferrer" className="h-[140px] w-[140px]">
          ...
          <Link href={"https://go.oasoobi.net/Discord"} target="_blank" rel="noopener noreferrer" className="col-span-2 h-[140px]">
